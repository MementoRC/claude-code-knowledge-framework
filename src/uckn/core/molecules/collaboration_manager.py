...
class CollaborationManager:
    ...
    async def get_comments(self, pattern_id: str, parent_id: Optional[str] = None) -> List[Comment]:
    ...
    async def get_activity_feed(self, team_id: Optional[str] = None, limit: int = 50) -> List[ActivityEvent]:
