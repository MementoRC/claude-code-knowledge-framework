...
try:
    ...
    # If we can't import the models, set target_metadata to None
    # This will still allow migrations to run manually
...
def get_database_url():
    ...
    # Try environment variables first (for CI/testing)
