...
class TechnologyStackDNA(BaseModel):
    ...
    confidence_score: float = Field(
        ge=0.0, le=1.0, description="Confidence score of detection"
    )
...
class HealthStatus(BaseModel):
    ...
    unified_db_available: bool = Field(
        description="Whether unified database is available"
    )
    semantic_search_available: bool = Field(
