...
from .common import BaseResponse, TechnologyStackDNA, SetupRecommendation, IssueWarning, UserRole
...
class ProjectMember(BaseModel):
    ...
    is_active: bool = Field(default=True, description="Whether user is active in project")


class ProjectSettings(BaseModel):
    """Project settings model"""
    auto_analyze: bool = Field(default=True, description="Automatically analyze project changes")
    pattern_suggestions: bool = Field(default=True, description="Enable pattern suggestions")
    issue_predictions: bool = Field(default=True, description="Enable issue predictions")
    collaboration_enabled: bool = Field(default=True, description="Enable collaboration features")
...
class ProjectMetrics(BaseModel):
    ...
    total_lines_of_code: Optional[int] = Field(default=None, description="Total lines of code")
    ...
    health_score: Optional[float] = Field(default=None, ge=0.0, le=1.0, description="Project health score")
    complexity_score: Optional[float] = Field(default=None, ge=0.0, le=10.0, description="Project complexity score")
    maintainability_score: Optional[float] = Field(default=None, ge=0.0, le=1.0, description="Maintainability score")
    test_coverage: Optional[float] = Field(default=None, ge=0.0, le=1.0, description="Test coverage percentage")
...
class ProjectCreate(BaseModel):
    ...
    project_type: ProjectType = Field(default=ProjectType.OTHER, description="Type of project")
...
class Project(BaseModel):
    ...
    project_path: Optional[str] = Field(default=None, description="Local project path")
    tags: List[str] = Field(default_factory=list, description="Project tags")
    technology_stack: Optional[TechnologyStackDNA] = Field(default=None, description="Detected technology stack")
...
class ProjectUpdate(BaseModel):
    ...
    visibility: Optional[ProjectVisibility] = Field(default=None, description="Updated visibility")
    status: Optional[ProjectStatus] = Field(default=None, description="Updated status")
    repository_url: Optional[str] = Field(default=None, description="Updated repository URL")
    project_path: Optional[str] = Field(default=None, description="Updated project path")
    tags: Optional[List[str]] = Field(default=None, description="Updated tags")
    settings: Optional[ProjectSettings] = Field(default=None, description="Updated settings")
...
class ProjectAnalysisRequest(BaseModel):
    ...
    include_patterns: bool = Field(default=True, description="Include pattern extraction")
    include_issues: bool = Field(default=True, description="Include issue prediction")
    include_recommendations: bool = Field(default=True, description="Include setup recommendations")
...
class ProjectAnalysisResponse(BaseResponse):
    ...
    technology_stack: TechnologyStackDNA = Field(description="Detected technology stack")
    recommendations: List[SetupRecommendation] = Field(description="Setup recommendations")
    ...
    health_score: Optional[float] = Field(default=None, description="Project health score")
    complexity_metrics: Optional[Dict[str, Any]] = Field(default=None, description="Complexity metrics")
...
class ProjectSearchRequest(BaseModel):
    ...
    visibility: Optional[ProjectVisibility] = Field(default=None, description="Filter by visibility")
    status: Optional[ProjectStatus] = Field(default=None, description="Filter by status")
    tags: Optional[List[str]] = Field(default=None, description="Filter by tags")
    technologies: Optional[List[str]] = Field(default=None, description="Filter by technologies")
...
class ProjectMemberInvite(BaseModel):
    ...
    permissions: Optional[List[str]] = Field(default=None, description="Specific permissions")
...
class ProjectMemberUpdate(BaseModel):
    ...
    permissions: Optional[List[str]] = Field(default=None, description="Updated permissions")
...
class ProjectStatsResponse(BaseResponse):
    ...
    projects_by_visibility: Dict[str, int] = Field(description="Projects grouped by visibility")
    avg_health_score: Optional[float] = Field(default=None, description="Average health score")
    total_patterns: int = Field(description="Total patterns across all projects")
    most_used_technologies: List[Dict[str, Any]] = Field(description="Most commonly used technologies")
