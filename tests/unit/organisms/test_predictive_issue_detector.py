...
def test_detect_issues_combines_rule_and_ml_results(predictive_issue_detector,
                                                     mock_tech_stack_detector,
                                                     mock_issue_detection_rules,
                                                     mock_issue_prediction_models):
    ...
    mock_issue_detection_rules.analyze_project_for_rules.assert_called_once_with(project_path)
...
def test_detect_issues_handles_ml_model_unavailability(predictive_issue_detector,
                                                        mock_issue_prediction_models):
...
def test_provide_feedback_records_data(predictive_issue_detector,
                                       mock_error_solution_manager,
                                       mock_pattern_analytics):
...
def test_detect_issues_with_code_snippet_and_context(predictive_issue_detector,
                                                     mock_issue_prediction_models):
