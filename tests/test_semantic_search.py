...
from uckn.core import SemanticSearch as SemanticSearchEngine
...
def test_availability_without_dependencies(temp_knowledge_dir):
    ...
    with patch("uckn.core.SENTENCE_TRANSFORMERS_AVAILABLE", False):
        engine = SemanticSearchEngine(temp_knowledge_dir)
...
def test_search_engine_graceful_degradation(temp_knowledge_dir):
    ...
    # If sentence_transformers is available, it should succeed; if not, it should fail
